...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-auto">Gerar Relátorio de Relógios</div>
        <div class="col">
            <hr>
        </div>
    </div>
    ...
    <form class="form-horizontal" method='POST' action="../relogio/armazenarDataSeccionRelogio">
        {!! method_field('POST') !!}
        {!! csrf_field() !!}
        <div class="row">
