...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-auto">Informações de Orçamento<h4 style="color: red">NÃO UTILIZAR AINDA - TESTE</h4></div>
        <div class="col">
            <hr>
        </div>
    </div>
    ...
    <form id="orcamentoForm" class="form-horizontal" method='POST' data-route="{{route('orcamento.adicionar')}}" enctype="multipart/form-data">
        ...
        <form class="form-horizontal" method='POST' action="{{route('pedido.update',$pedido->ID_pedido)}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        @if($firma == 'FM')
                        <input required id="cod_orcamento" name="cod_orcamento" type="text" class="form-control" value="{{$pedido->OF ?? ''}}">
                        @else
                        <input required id="cod_orcamento" name="cod_orcamento" type="text" class="form-control" value="{{$pedido->OF ?? '' }}">
                        @endif
                    </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input required  id="prazo_entrega" name="prazo_entrega" type="number" class="form-control" value="{{$pedido->data_pedido ?? '' }}">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="form-group col-md-1">
                    <a readonly href="{{route('orcamento.mostrar')}}" class="btn btn-primary">
