        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input id="data_inicio" name="data_inicio" value="{{date('Y-m-01')}}" type="date" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input id="data_fim" name="data_fim" type="date" value="{{date('Y-m-t')}}" class="form-control" required>
                </div>
            </div>
