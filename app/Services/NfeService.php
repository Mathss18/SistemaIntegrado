...
class NfeService
{
    ...
    public function gerarNfe($nfe1, $nfe2, $nfe3, $datas, $transpo, $cliente, $nNFdb, $aliquota)
    {
        ...
        $ide->finNFe = 1; // Finalidade de emissão da NF-e  1- NF-e normal/ 2-NF-e complementar / 3 – NF-e de ajuste change 1
        ...
        /*
        $nfeRef = new stdClass();
        $nfeRef->refNFe = '35210220655436000126550010000359121493693227';

        $respIde = $nfe->tagrefNFe($nfeRef);
        */
        ...
        $icmsTotal->vNF = $nfe3['precoFinal'] + $nfe1['valorFrete']; // change 
        ...
        if ($nfe1['numParc'] >= 1) {
            ...
            /*
                    $dup1 = new stdClass();
                    $dup1->nDup = '001';
                    $dup1->dVenc = '2021-03-05';
                    $dup1->vDup = 10300.50;
                    $nfe->tagdup($dup1);
                   
                    $dup2 = new stdClass();
                    $dup2->nDup = '002';
                    $dup2->dVenc = '2021-04-05';
                    $dup2->vDup = 5150.25;
                    $nfe->tagdup($dup2);

                    $dup3 = new stdClass();
                    $dup3->nDup = '003';
                    $dup3->dVenc = '2021-05-05';
                    $dup3->vDup = 5150.25;
                    $nfe->tagdup($dup3);
        ...
        $detPag = new stdClass();
        $detPag->tPag = '15'; //change 90
        $detPag->vPag = $nfe3['precoFinal'] + $nfe1['valorFrete']; //Obs: deve ser informado o valor pago pelo cliente change 0.00
